...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="glass-card p-6 border-purple-500/20">
                <h3 className="text-xl font-bold mb-6 flex items-center">
                  <Terminal className="mr-3 text-purple-400" size={24} />
                  Tools & Platforms
                </h3>
                <div className="space-y-4">
      ...
      <section id="projects" className={`py-20 ${visibleSections.projects ? 'fade-in' : ''}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl sm:text-5xl font-bold mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {projects.map((project, index) => (
                <Card 
                  key={project.id} 
                  className="glass-card p-6 border-purple-500/20 hover:scale-[1.02] transition-all duration-300"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-2xl font-bold text-white">{project.title}</h3>
                    <ExternalLink className="text-purple-400 cursor-pointer hover:scale-110 transition-transform" size={20} />
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, idx) => (
                      <Badge 
                        key={idx}
                        variant="outline"
                        className="px-3 py-1 text-xs border-purple-500/30 text-purple-400 bg-purple-500/5"
                      >
                        {tech}
                      </Badge>
                    ))}
            ...
            <Card className="glass-card p-8 sm:p-12 border-purple-500/20">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a
                  ...
                  className="flex flex-col items-center p-6 bg-white/5 rounded-lg border border-purple-500/20 hover:bg-white/10 hover:border-purple-500/40 transition-all duration-300 group"
                >
                  <Mail className="text-purple-400 mb-3 group-hover:scale-110 transition-transform" size={32} />
                ...
                <a
                  ...
                  className="flex flex-col items-center p-6 bg-white/5 rounded-lg border border-purple-500/20 hover:bg-white/10 hover:border-purple-500/40 transition-all duration-300 group"
                >
                  <Linkedin className="text-purple-400 mb-3 group-hover:scale-110 transition-transform" size={32} />
                ...
                <a
                  ...
                  className="flex flex-col items-center p-6 bg-white/5 rounded-lg border border-purple-500/20 hover:bg-white/10 hover:border-purple-500/40 transition-all duration-300 group"
                >
                  <Phone className="text-purple-400 mb-3 group-hover:scale-110 transition-transform" size={32} />
